    ...
    <div class="relative z-10 mx-auto max-w-7xl space-y-6">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-3xl border border-cyan-200/50 dark:border-cyan-700/30 bg-gradient-to-br from-cyan-50/80 to-white/60 dark:from-cyan-900/20 dark:to-slate-800/40 p-6 shadow-lg shadow-cyan-100/50 dark:shadow-none backdrop-blur-xl">
                ...
                <p class="mt-2 text-4xl font-extrabold text-slate-800 dark:text-white"><?php echo e($companies->count()); ?></p>
            </div>
            <div class="rounded-3xl border border-emerald-200/50 dark:border-emerald-700/30 bg-gradient-to-br from-emerald-50/80 to-white/60 dark:from-emerald-900/20 dark:to-slate-800/40 p-6 shadow-lg shadow-emerald-100/50 dark:shadow-none backdrop-blur-xl">
                ...
                <p class="mt-2 text-4xl font-extrabold text-slate-800 dark:text-white"><?php echo e($processes->count()); ?></p>
            </div>
            <div class="rounded-3xl border border-indigo-200/50 dark:border-indigo-700/30 bg-gradient-to-br from-indigo-50/80 to-white/60 dark:from-indigo-900/20 dark:to-slate-800/40 p-6 shadow-lg shadow-indigo-100/50 dark:shadow-none backdrop-blur-xl">
                ...
                <p class="mt-2 text-4xl font-extrabold text-slate-800 dark:text-white"><?php echo e($teams->count()); ?></p>
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
            ...
            <div class="space-y-6 xl:col-span-2">
                ...
                <div class="rounded-3xl border border-white/40 dark:border-slate-700/40 bg-white/60 dark:bg-slate-800/40 p-6 shadow-xl shadow-slate-200/50 dark:shadow-none backdrop-blur-xl">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.config.companies.store')); ?>" class="mb-6 flex gap-3">
                        <?php echo csrf_field(); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="rounded-2xl border border-white/50 dark:border-slate-600/40 bg-white/40 dark:bg-slate-700/30 p-3 shadow-sm backdrop-blur-md">
                                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                    <form method="POST" action="<?php echo e(route('admin.config.companies.update', $company)); ?>" class="flex flex-1 gap-2">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <input type="text" name="name" value="<?php echo e($company->name); ?>" class="flex-1 rounded-lg border border-white/60 dark:border-slate-600/50 bg-white/50 dark:bg-slate-800/50 px-3 py-1.5 text-sm text-slate-800 dark:text-slate-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                ...
                <div class="rounded-3xl border border-white/40 dark:border-slate-700/40 bg-white/60 dark:bg-slate-800/40 p-6 shadow-xl shadow-slate-200/50 dark:shadow-none backdrop-blur-xl">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.config.processes.store')); ?>" class="mb-6 flex gap-3">
                        <?php echo csrf_field(); ?>
                    ...
                    <ul class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $process): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="rounded-2xl border border-white/50 dark:border-slate-600/40 bg-white/40 dark:bg-slate-700/30 p-3 shadow-sm backdrop-blur-md">
                                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                    <form method="POST" action="<?php echo e(route('admin.config.processes.update', $process)); ?>" class="flex flex-1 gap-2">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <input type="text" name="name" value="<?php echo e($process->name); ?>" class="flex-1 rounded-lg border border-white/60 dark:border-slate-600/50 bg-white/50 dark:bg-slate-800/50 px-3 py-1.5 text-sm text-slate-800 dark:text-slate-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                                        <button class="rounded-lg border border-cyan-300/50 dark:border-cyan-500/30 bg-cyan-50/50 dark:bg-cyan-500/10 px-3 py-1.5 text-xs font-semibold text-cyan-700 dark:text-cyan-300 transition-colors hover:bg-cyan-100 dark:hover:bg-cyan-500/20" type="submit">Save</button>
                                    </form>
                ...
                <div class="rounded-3xl border border-white/40 dark:border-slate-700/40 bg-white/60 dark:bg-slate-800/40 p-6 shadow-xl shadow-slate-200/50 dark:shadow-none backdrop-blur-xl">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.config.teams.store')); ?>" class="mb-6 flex gap-3">
                        <?php echo csrf_field(); ?>
                    ...
                    <ul class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="rounded-2xl border border-white/50 dark:border-slate-600/40 bg-white/40 dark:bg-slate-700/30 p-3 shadow-sm backdrop-blur-md">
                                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                    <form method="POST" action="<?php echo e(route('admin.config.teams.update', $team)); ?>" class="flex flex-1 gap-2">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <input type="text" name="name" value="<?php echo e($team->name); ?>" class="flex-1 rounded-lg border border-white/60 dark:border-slate-600/50 bg-white/50 dark:bg-slate-800/50 px-3 py-1.5 text-sm text-slate-800 dark:text-slate-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                                        <button class="rounded-lg border border-cyan-300/50 dark:border-cyan-500/30 bg-cyan-50/50 dark:bg-cyan-500/10 px-3 py-1.5 text-xs font-semibold text-cyan-700 dark:text-cyan-300 transition-colors hover:bg-cyan-100 dark:hover:bg-cyan-500/20" type="submit">Save</button>
                                    </form>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-3xl border border-white/40 dark:border-slate-700/40 bg-white/60 dark:bg-slate-800/40 p-6 shadow-xl shadow-slate-200/50 dark:shadow-none backdrop-blur-xl">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div class="flex h-40 w-full items-center justify-center rounded-2xl border-2 border-dashed border-slate-300/50 dark:border-slate-600/50 bg-white/30 dark:bg-slate-800/30 p-2 overflow-hidden">
                            <?php if($logoPath): ?>
                                <img src="<?php echo e(asset('storage/' . $logoPath)); ?>" alt="Company Logo" class="max-h-full object-contain drop-shadow-md">
                            <?php else: ?>
                                <span class="text-sm font-medium text-slate-400 dark:text-slate-500">No logo uploaded yet</span>
                            <?php endif; ?>
                        </div>
                        <form action="<?php echo e(route('admin.config.logo.update')); ?>" method="POST" enctype="multipart/form-data" class="w-full">
                            <?php echo csrf_field(); ?>
                ...
                <div class="rounded-3xl border border-white/40 dark:border-slate-700/40 bg-white/60 dark:bg-slate-800/40 p-6 shadow-xl shadow-slate-200/50 dark:shadow-none backdrop-blur-xl">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.config.announcement.update')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>

                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Report Recipients</label>
                            <input type="text" name="daily_report_recipients" value="<?php echo e(old('daily_report_recipients', $dailyReportRecipients ?? '')); ?>" placeholder="manager@company.com" class="w-full rounded-xl border border-white/50 dark:border-slate-600/50 bg-white/50 dark:bg-slate-800/50 px-4 py-2.5 text-sm text-slate-800 dark:text-slate-200 shadow-sm backdrop-blur-md focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 placeholder:text-slate-400">
                        ...
                        <div>
                            ...
                            <input type="email" name="personal_alert_email" value="<?php echo e(old('personal_alert_email', $personalAlertEmail ?? '')); ?>" placeholder="you@email.com" class="w-full rounded-xl border border-white/50 dark:border-slate-600/50 bg-white/50 dark:bg-slate-800/50 px-4 py-2.5 text-sm text-slate-800 dark:text-slate-200 shadow-sm backdrop-blur-md focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 placeholder:text-slate-400">
                        ...
                        <div>
                            ...
                            <input type="email" name="deadline_alert_bcc" value="<?php echo e(old('deadline_alert_bcc', $deadlineAlertBcc ?? '')); ?>" placeholder="audit@email.com" class="w-full rounded-xl border border-white/50 dark:border-slate-600/50 bg-white/50 dark:bg-slate-800/50 px-4 py-2.5 text-sm text-slate-800 dark:text-slate-200 shadow-sm backdrop-blur-md focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 placeholder:text-slate-400">
                        ...
                        <div>
                            ...
                            <textarea name="announcement" rows="4" class="w-full rounded-xl border border-white/50 dark:border-slate-600/50 bg-white/50 dark:bg-slate-800/50 px-4 py-2.5 text-sm text-slate-800 dark:text-slate-200 shadow-sm backdrop-blur-md focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 placeholder:text-slate-400"><?php echo e(old('announcement', $announcement)); ?></textarea>
                        </div>
                ...
                <div class="rounded-3xl border border-amber-200/50 dark:border-amber-700/30 bg-gradient-to-br from-amber-50/80 to-white/60 dark:from-amber-900/20 dark:to-slate-800/40 p-6 shadow-xl shadow-amber-100/50 dark:shadow-none backdrop-blur-xl">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.email.broadcast')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="4" required class="w-full rounded-xl border border-amber-300/50 dark:border-amber-600/50 bg-white/50 dark:bg-slate-800/50 px-4 py-2.5 text-sm text-slate-800 dark:text-slate-200 shadow-sm backdrop-blur-md focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50"><?php echo e(old('message', 'This is a broadcast email from Movaflex Task Manager.')); ?></textarea>
                        </div>
