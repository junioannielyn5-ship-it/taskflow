...
<div class="space-y-6">
    ...
    <div class="bg-white/80 dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-[3rem] shadow-2xl overflow-hidden">
        ...
        <div class="grid grid-cols-7 text-center border-b border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-white/5">
            ...
            <div class="py-5 text-xs font-bold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400"><?php echo e($dow); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="grid grid-cols-7">
            <?php $__currentLoopData = \Carbon\CarbonPeriod::create($startOfGrid, '1 day', $endOfGrid); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    ...
                    $isToday = $day->isToday();
                ?>
                <div class="min-h-[140px] border-b border-r border-slate-200 dark:border-white/5 p-4 transition-all group hover:bg-slate-50 dark:hover:bg-white/5 relative <?php echo e($isCurrentMonth ? '' : 'opacity-40'); ?>">
                    <div class="mb-2 flex items-center justify-between">
                        ...
                        <?php else: ?>
                            <span class="text-base font-bold text-slate-500 group-hover:text-slate-800 dark:group-hover:text-white transition-colors"><?php echo e($day->day); ?></span>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Local.Administrator\Herd\taskmanagement\resources\views\tasks\calendar.blade.php ENDPATH**/ ?>