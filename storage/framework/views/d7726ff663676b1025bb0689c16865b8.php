    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; margin:0 auto; background:#ffffff; border:1px solid #e5e7eb; border-radius:12px; overflow:hidden;">
        ...
        <tr>
            <td style="padding:20px;">
                ...
                <p style="margin:0 0 12px;">You have been assigned a new task: <strong><?php echo e($task->title); ?></strong>.</p>
                <p style="margin:0 0 8px;"><strong>Company Client:</strong> <?php echo e($task->company ?: '-'); ?></p>
                <p style="margin:0 0 8px;"><strong>Team In Charge:</strong> <?php echo e($task->team_in_charge ?: '-'); ?></p>
                <p style="margin:0 0 8px;"><strong>Target Deadline:</strong> <?php echo e($task->due_date ? $task->due_date->format('M d, Y') : '-'); ?></p>
                <p style="margin:0 0 16px;"><strong>Priority:</strong> <?php echo e(strtoupper($task->priority ?? '-')); ?></p>
                <a href="<?php echo e($taskUrl); ?>" style="display:inline-block; background:#1d4ed8; color:#ffffff; text-decoration:none; padding:10px 14px; border-radius:8px; font-size:14px;">Open Task</a>
            </td>
        </tr>
        <tr>
...
<?php /**PATH C:\Users\Local.Administrator\Herd\taskmanagement\resources\views/emails/task-assigned.blade.php ENDPATH**/ ?>