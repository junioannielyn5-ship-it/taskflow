...
<div class="space-y-6">
    ...
    <div id="kanban-board" class="grid grid-cols-1 gap-4 lg:grid-cols-4">
        ...
        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tasks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="kanban-column rounded-2xl border p-4 shadow-sm <?php echo e($columnMeta[$key]['columnClass']); ?>" data-target-status="<?php echo e($targetStatus); ?>">
                ...
                <div class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <div class="kanban-card rounded-xl border p-3 <?php echo e($columnMeta[$key]['cardClass']); ?> <?php echo e($isDelayed ? 'ring-1 ring-red-300' : ''); ?>" data-task-id="<?php echo e($task->id); ?>" data-project-id="<?php echo e($task->project?->id ?? ''); ?>" draggable="true">
                            <div class="mb-2 flex items-start justify-between gap-2">
                                <a href="<?php echo e(route('tasks.show', $task)); ?>" class="text-sm font-semibold text-slate-800 hover:text-blue-600 hover:underline dark:text-slate-100"><?php echo e($task->title); ?></a>
                            ...
                            <div class="space-y-1 text-xs text-slate-600 dark:text-slate-300">
                                <p><span class="font-semibold">Project:</span> <?php echo e($task->project?->name ?: '-'); ?></p>
                                <p><span class="font-semibold">Task No:</span> <?php echo e($taskNo); ?></p>
                                <p><span class="font-semibold">Due:</span> <?php echo e($task->due_date ? $task->due_date->format('m-d-Y') : '-'); ?></p>
                                <p><span class="font-semibold">Project Owner:</span> <?php echo e($projectOwner); ?></p>
                                <p><span class="font-semibold">Person-in-charge:</span> <?php echo e($task->team_in_charge ?: '-'); ?></p>
                                <?php if($isDelayed): ?>
                                    <p><span class="font-semibold text-red-700">Overdue:</span> <span class="text-red-700"><?php echo e($overdueDays); ?> day(s)</span></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
