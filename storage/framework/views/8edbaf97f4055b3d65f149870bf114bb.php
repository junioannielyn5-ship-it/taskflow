            ...
            <div class="kanban-column rounded-2xl border p-4 shadow-xl <?php echo e($columnMeta[$key]['columnClass']); ?>" data-target-status="<?php echo e($targetStatus); ?>">
                ...
                <div class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <div class="kanban-card relative z-10 rounded-xl border p-4 <?php echo e($columnMeta[$key]['cardClass']); ?> <?php echo e($isDelayed ? 'ring-2 ring-red-400/60 dark:ring-red-500/60 bg-red-50/50 dark:bg-red-900/10' : ''); ?> transition-all duration-300" data-task-id="<?php echo e($task->id); ?>" data-project-id="<?php echo e($task->project?->id ?? ''); ?>" draggable="true">
