...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['dark' => ($appearance ?? 'system') == 'dark']); ?>">
    <head>
        ...
        <title inertia><?php echo e(config('app.name', 'Movaflex Task Manager')); ?></title>
    ...
    <body class="font-sans antialiased">
        ...
        <?php if (! (str_starts_with($page['component'], 'auth/'))): ?>
...
<?php /**PATH C:\Users\Local.Administrator\Herd\taskmanagement\resources\views\app.blade.php ENDPATH**/ ?>