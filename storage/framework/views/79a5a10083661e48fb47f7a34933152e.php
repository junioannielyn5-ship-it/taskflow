...
<div class="cover">
    ...
    <h1>User Manual</h1>
    <div class="meta">Generated: <?php echo e(now()->format('F d, Y')); ?> &nbsp;|&nbsp; Movaflex Designs Unlimited Inc.</div>
</div>
...
<div class="section">
    ...
    <table class="items">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td class="dot"><span></span></td>
            <td class="label"><?php echo e($label); ?></td>
            <td class="desc"><?php echo e($desc); ?></td>
        </tr>
...
<div class="footer">
    © <?php echo e(now()->year); ?> Movaflex Designs Unlimited Inc. &nbsp;|&nbsp; TaskFlow Workspace &nbsp;|&nbsp; User Manual v1.0
</div>

</body>
</html>
<?php /**PATH C:\Users\Local.Administrator\Herd\taskmanagement\resources\views\help-pdf.blade.php ENDPATH**/ ?>