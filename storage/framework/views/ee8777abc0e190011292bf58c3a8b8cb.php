...
<div class="space-y-6 tasks-page">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-5">
        <a href="<?php echo e(route('tasks.list')); ?>" class="block rounded-2xl border border-blue-300 bg-blue-50 px-4 py-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <p class="text-xs font-semibold uppercase tracking-wide text-blue-700">Active Projects</p>
            <p class="mt-1 text-2xl font-bold text-blue-900"><?php echo e($activeProjectsCount ?? 0); ?></p>
        </a>
        <a href="<?php echo e(route('tasks.list', ['assignee' => auth()->id()])); ?>" class="block rounded-2xl border border-amber-300 bg-amber-50 px-4 py-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <p class="text-xs font-semibold uppercase tracking-wide text-amber-700">My Tasks</p>
            <p class="mt-1 text-2xl font-bold text-amber-900"><?php echo e($myTasksCount ?? 0); ?></p>
        </a>
        <a href="<?php echo e(route('tasks.list', ['status' => 'for_review'])); ?>" class="block rounded-2xl border border-orange-300 bg-orange-50 px-4 py-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <p class="text-xs font-semibold uppercase tracking-wide text-orange-700">Pending Review</p>
            <p class="mt-1 text-2xl font-bold text-orange-900"><?php echo e($pendingReviewCount ?? 0); ?></p>
        </a>
        <a href="<?php echo e(route('tasks.list', ['overdue' => 1])); ?>" class="block rounded-2xl border border-orange-300 bg-orange-50 px-4 py-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <p class="text-xs font-semibold uppercase tracking-wide text-orange-700">Overdue</p>
            <p class="mt-1 text-2xl font-bold text-orange-900"><?php echo e($overdueCount ?? 0); ?></p>
        </a>
        <a href="<?php echo e(route('tasks.list', ['tab' => 'done'])); ?>" class="block rounded-2xl border border-emerald-300 bg-emerald-50 px-4 py-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            <p class="text-xs font-semibold uppercase tracking-wide text-emerald-700">Done</p>
            <p class="mt-1 text-2xl font-bold text-emerald-900"><?php echo e($doneTasksCount ?? 0); ?></p>
        </a>
    </div>
    ...
    <div class="mv-card inline-flex p-1">
        <a
            ...
            class="rounded-lg px-4 py-2 text-sm font-semibold <?php echo e($currentTab === 'active' ? 'bg-teal-700 text-white' : 'text-slate-600 hover:bg-slate-100'); ?>"
        >
            Active Tasks
        </a>
        <a
            href="<?php echo e(route('tasks.list', array_merge(request()->except(['tab', 'page']), ['tab' => 'done']))); ?>"
            class="rounded-lg px-4 py-2 text-sm font-semibold <?php echo e($currentTab === 'done' ? 'bg-emerald-700 text-white' : 'text-slate-600 hover:bg-slate-100'); ?>"
        >
            Checklist / Completed
        </a>
    </div>

    <form method="GET" action="<?php echo e(route('tasks.list')); ?>" class="mv-card border border-white/30 bg-white/95 dark:bg-slate-800 dark:border-slate-700 p-4 shadow-xl">
        <div class="grid grid-cols-1 gap-4 <?php echo e($currentTab === 'done' ? 'md:grid-cols-6' : 'md:grid-cols-8'); ?>">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('tasks.list')); ?>" class="rounded border border-gray-300 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Clear</a>
            </div>
        </div>
    </form>
                ...
                <tbody class="bg-white dark:bg-slate-800">
                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="<?php echo e($rowAccentClass); ?> <?php echo e($isDelayed ? 'is-overdue-row' : ''); ?> border-b border-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors duration-200">
                            ...
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($projectOwner); ?></td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->team_in_charge ?: '-'); ?></td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
                            ...
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->specific_process ?: '-'); ?></td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
                            ...
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->company ?: '-'); ?></td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->project?->name ?? 'N/A'); ?></td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->deliverables ?: '-'); ?></td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
                            ...
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
                                ...
                                <?php if(($task->comments_count ?? 0) > 0 && $task->latestComment): ?>
                                    <div class="mt-2 rounded border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 p-2">
                                        <p class="text-[11px] font-semibold text-slate-700 dark:text-slate-300">Latest comment (<?php echo e($task->comments_count); ?>)</p>
                                        ...
                                        <p class="mt-1 text-[11px] text-slate-500 dark:text-slate-400"><?php echo e($task->latestComment->user?->name ?? 'Unknown'); ?> • <?php echo e($task->latestComment->created_at?->diffForHumans()); ?></p>
                                    </div>
                                <?php endif; ?>
                            </td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
                                ...
                                <p class="mt-1 text-[11px] font-medium text-slate-500 dark:text-slate-400">Workflow: <?php echo e($workflowStatusLabel); ?></p>
                            </td>
                            <td class="py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
                                <?php
                            ...
                            <td class="whitespace-nowrap py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->date_received ? \Carbon\Carbon::parse($task->date_received)->format('M d, Y') : '-'); ?></td>
                            <td class="whitespace-nowrap py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->date_started ? $task->date_started->format('M d, Y') : '-'); ?></td>
                            <td class="whitespace-nowrap py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($dateFinish ? $dateFinish->format('M d, Y') : '-'); ?></td>
                            <td class="whitespace-nowrap py-4 px-3 text-[11px] font-medium leading-relaxed <?php echo e($isDelayed ? 'font-semibold text-amber-700 dark:text-amber-400' : 'text-slate-700 dark:text-slate-200'); ?>">
    ...
    <?php if($currentTab === 'done'): ?>
        <div id="done-tasks" class="mt-2 mb-3 flex items-center justify-between">
            ...
            <span class="text-xs text-gray-500 dark:text-slate-500"><?php echo e($doneTasksCount ?? 0); ?> completed task(s)</span>
        </div>
                ...
                <tbody class="bg-white dark:bg-slate-800">
                    <?php $__currentLoopData = $doneTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="border-l-4 border-emerald-500 border-b border-slate-200 dark:border-slate-700 bg-emerald-50/30 dark:bg-emerald-950/30 hover:bg-slate-50 dark:hover:bg-slate-700 dark:hover:bg-slate-700 transition-colors duration-200">
                            ...
                            <td class="whitespace-nowrap py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->date_started ? $task->date_started->format('M d, Y') : '-'); ?></td>
                            <td class="whitespace-nowrap py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($dateFinish ? $dateFinish->format('M d, Y') : '-'); ?></td>
                            <td class="whitespace-nowrap py-4 px-3 text-[11px] font-medium text-slate-700 dark:text-slate-200 leading-relaxed"><?php echo e($task->due_date ? $task->due_date->format('m-d-Y') : '-'); ?></td>
                            <td class="whitespace-nowrap py-4 px-3 text-right text-[11px]">
                                <a href="<?php echo e(route('tasks.show', $task)); ?>" class="mr-2 rounded border border-blue-200 dark:border-blue-700 px-3 py-1 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30">Open</a>
                                <span class="text-gray-300">-</span>
                            </td>
