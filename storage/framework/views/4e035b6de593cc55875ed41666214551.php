...
<div class="space-y-6">
    ...
    <section class="grid gap-4 md:grid-cols-3">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-project')): ?>
            <a href="<?php echo e(route('projects.create')); ?>" class="group rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-cyan-300 dark:hover:border-cyan-500 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgba(6,182,212,0.15)]">
        ...
        <a href="<?php echo e(route('tasks.list')); ?>" class="group rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-cyan-300 dark:hover:border-cyan-500 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgba(6,182,212,0.15)]">
        ...
        <a href="<?php echo e(route('reports.index')); ?>" class="group rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-cyan-300 dark:hover:border-cyan-500 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgba(6,182,212,0.15)]">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Local.Administrator\Herd\taskmanagement\resources\views\manager\index.blade.php ENDPATH**/ ?>