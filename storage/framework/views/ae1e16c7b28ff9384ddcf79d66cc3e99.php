    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:680px; margin:0 auto; background:#ffffff; border:1px solid #e5e7eb; border-radius:12px; overflow:hidden;">
        ...
        <tr>
            <td style="padding:20px;">
                ...
                <p style="margin:0 0 12px;">You currently have <strong><?php echo e($tasks->count()); ?></strong> delayed task(s):</p>
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-bottom:16px;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="font-size:13px; padding:8px 0; border-bottom:1px solid #f1f5f9;"><?php echo e($task->title); ?></td>
                                <td style="font-size:13px; padding:8px 0; border-bottom:1px solid #f1f5f9;"><?php echo e($task->company ?: '-'); ?></td>
                                <td style="font-size:13px; padding:8px 0; border-bottom:1px solid #f1f5f9;"><?php echo e($task->due_date ? $task->due_date->format('M d, Y') : '-'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
                <a href="<?php echo e($tasksUrl); ?>" style="display:inline-block; background:#0f172a; color:#ffffff; text-decoration:none; padding:10px 14px; border-radius:8px; font-size:14px;">Open Task List</a>
            </td>
        </tr>
        <tr>
...
<?php /**PATH C:\Users\Local.Administrator\Herd\taskmanagement\resources\views\emails\delayed-tasks-daily-summary.blade.php ENDPATH**/ ?>