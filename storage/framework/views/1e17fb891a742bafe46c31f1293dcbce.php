...
<div class="relative space-y-8 tasks-page">
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-5">
        <!-- Active Projects -->
        <a href="<?php echo e(route('tasks.list')); ?>" class="group relative overflow-hidden rounded-2xl border border-white/40 bg-white/60 p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-slate-700/50 dark:bg-slate-800/60 dark:shadow-slate-900/50">
            ...
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-black text-slate-800 dark:text-white"><?php echo e($activeProjectsCount ?? 0); ?></p>
                </div>
        ...
        <!-- My Tasks -->
        <a href="<?php echo e(route('tasks.list', ['assignee' => auth()->id()])); ?>" class="group relative overflow-hidden rounded-2xl border border-white/40 bg-white/60 p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-slate-700/50 dark:bg-slate-800/60 dark:shadow-slate-900/50">
            ...
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-black text-slate-800 dark:text-white"><?php echo e($myTasksCount ?? 0); ?></p>
                </div>
        ...
        <!-- Pending Review -->
        <a href="<?php echo e(route('tasks.list', ['status' => 'for_review'])); ?>" class="group relative overflow-hidden rounded-2xl border border-white/40 bg-white/60 p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-slate-700/50 dark:bg-slate-800/60 dark:shadow-slate-900/50">
            ...
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-black text-slate-800 dark:text-white"><?php echo e($pendingReviewCount ?? 0); ?></p>
                </div>
        ...
        <!-- Overdue -->
        <a href="<?php echo e(route('tasks.list', ['overdue' => 1])); ?>" class="group relative overflow-hidden rounded-2xl border border-white/40 bg-white/60 p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-slate-700/50 dark:bg-slate-800/60 dark:shadow-slate-900/50">
            ...
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-black text-slate-800 dark:text-white"><?php echo e($overdueCount ?? 0); ?></p>
                </div>
        ...
        <!-- Done -->
        <a href="<?php echo e(route('tasks.list', ['tab' => 'done'])); ?>" class="group relative overflow-hidden rounded-2xl border border-white/40 bg-white/60 p-5 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-slate-700/50 dark:bg-slate-800/60 dark:shadow-slate-900/50">
            ...
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-black text-slate-800 dark:text-white"><?php echo e($doneTasksCount ?? 0); ?></p>
                </div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
        <div class="relative inline-flex items-center overflow-hidden rounded-xl border border-white/20 bg-white/40 p-1 shadow-sm backdrop-blur-md dark:border-slate-700/50 dark:bg-slate-800/40">
            <a href="<?php echo e(route('tasks.list', array_merge(request()->except(['tab', 'done_page', 'page']), ['tab' => 'active']))); ?>"
               class="relative flex items-center justify-center rounded-lg px-5 py-2 text-sm font-bold transition-all duration-200 <?php echo e($currentTab === 'active' ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md' : 'text-slate-600 hover:bg-white/50 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-700/50 dark:hover:text-white'); ?>">
            ...
            <a href="<?php echo e(route('tasks.list', array_merge(request()->except(['tab', 'page']), ['tab' => 'done']))); ?>"
               class="relative flex items-center justify-center rounded-lg px-5 py-2 text-sm font-bold transition-all duration-200 <?php echo e($currentTab === 'done' ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md' : 'text-slate-600 hover:bg-white/50 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-700/50 dark:hover:text-white'); ?>">
    ...
    <form method="GET" action="<?php echo e(route('tasks.list')); ?>" class="relative overflow-hidden rounded-2xl border border-white/40 bg-white/40 p-5 shadow-lg backdrop-blur-xl dark:border-slate-700/50 dark:bg-slate-800/40">
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 items-end">
            ...
            <div>
                ...
                <input id="company" type="text" name="company" value="<?php echo e($filters['company'] ?? ''); ?>" placeholder="Client..." class="block w-full rounded-xl border-0 bg-white/70 py-2.5 px-3 text-sm font-medium text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300/50 backdrop-blur-sm transition-all focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 dark:bg-slate-900/50 dark:text-white dark:ring-slate-700/50 dark:focus:bg-slate-800 dark:focus:ring-blue-500 placeholder:text-slate-400">
            </div>
            ...
            <div>
                ...
                <input id="date_received" type="date" name="date_received" value="<?php echo e($filters['date_received'] ?? ''); ?>" class="block w-full rounded-xl border-0 bg-white/70 py-2.5 px-3 text-sm font-medium text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300/50 backdrop-blur-sm transition-all focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 dark:bg-slate-900/50 dark:text-white dark:ring-slate-700/50 dark:focus:bg-slate-800 dark:focus:ring-blue-500">
            </div>
        ...
        <div class="mt-5 flex items-center justify-end gap-3 border-t border-slate-200/50 pt-4 dark:border-slate-700/50">
            <a href="<?php echo e(route('tasks.list')); ?>" class="inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm font-bold text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-700/50 dark:hover:text-white">
                Clear Filters
            </a>
    ...
    <?php if($currentTab === 'active'): ?>
        ...
        <?php else: ?>
            <div class="mb-3 flex items-center justify-between">
                ...
                <span class="rounded-full bg-blue-100 px-2.5 py-1 text-xs font-semibold text-blue-700 dark:bg-blue-900/40 dark:text-blue-300"><?php echo e($tasks->total()); ?> task(s)</span>
            </div>
            <div class="overflow-x-auto rounded-2xl border border-white/40 bg-white/60 shadow-xl backdrop-blur-xl dark:border-slate-700/50 dark:bg-slate-800/60 dark:shadow-slate-900/50">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/30 bg-transparent">
                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr class="<?php echo e($rowAccentClass); ?> <?php echo e($isDelayed ? 'is-overdue-row bg-red-50/20 dark:bg-red-950/20' : 'bg-transparent'); ?> hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors duration-200">
                            ...
                            <td class="whitespace-nowrap py-4 px-3 text-right text-xs">
                                ...
                                <?php if(auth()->user()?->isAdmin()): ?>
                                    <a href="<?php echo e(route('tasks.edit', $task)); ?>" class="mr-2 rounded-lg border border-yellow-200/50 bg-yellow-50/50 px-3 py-1.5 font-bold text-yellow-600 transition-colors hover:bg-yellow-100 dark:border-yellow-700/50 dark:bg-yellow-900/30 dark:text-yellow-400 dark:hover:bg-yellow-800/50">Edit</a>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Local.Administrator\Herd\taskmanagement\resources\views\tasks\index.blade.php ENDPATH**/ ?>