...
<div class="relative space-y-4">
    ...
    <form method="GET" action="<?php echo e(route('audit-logs.index')); ?>">
        <div class="relative overflow-hidden rounded-xl border border-slate-200/40 bg-white/80 p-3 sm:p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900/90 flex flex-wrap items-end gap-3 mb-4">
            ...
            <div class="flex items-center gap-2 ml-auto">
                <a href="<?php echo e(route('audit-logs.index')); ?>" class="inline-flex items-center justify-center rounded-lg px-3.5 py-1.5 text-xs font-bold text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800/50">Clear</a>
    ...
    <div class="rounded-xl border border-slate-200/40 bg-white/90 shadow-sm dark:border-slate-800 dark:bg-slate-900/90 overflow-hidden">
        <div class="px-4 py-3 border-b border-slate-200/40 dark:border-slate-800 flex items-center justify-between">
            ...
            <span class="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-semibold text-slate-600 dark:bg-slate-800 dark:text-slate-350 border border-slate-200 dark:border-slate-700"><?php echo e($auditLogs->total()); ?> total entries</span>
        </div>
                ...
                <table class="w-full text-left text-xs text-slate-600 dark:text-slate-300">
                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-850">
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-850/50 transition-colors">
                            ...
                            <td class="px-3 py-2.5 text-xs whitespace-nowrap">
                                <span class="font-mono bg-slate-100 dark:bg-white/10 px-1.5 py-0.5 rounded text-blue-600 dark:text-[#93C5FD] text-[10px] border border-slate-200/40 dark:border-white/15"><?php echo e($log->model_label ?? '#' . $log->model_id); ?></span>
                            </td>
