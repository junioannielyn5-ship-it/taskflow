...
<div class="mx-auto max-w-7xl">
    <div class="mb-6 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('supplier.export')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-4 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-700">
        ...
        <div class="border-b border-slate-200 p-4 dark:border-slate-700">
            <form method="GET" action="<?php echo e(route('supplier.index')); ?>" class="flex max-w-md items-center gap-2">
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search by name, category, status..." class="w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-9 pr-4 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-white">
                </div>
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    <?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                            <td class="whitespace-nowrap px-6 py-4 font-semibold text-slate-900 dark:text-white"><?php echo e($item->name); ?></td>
                            <td class="px-6 py-4">
                                <?php
                                    $sColors = [
                                ...
                                ?>
                                <select onchange="updateInlineStatus(this, <?php echo e($item->id); ?>, 'supplier')" class="text-xs font-medium rounded-full px-2.5 py-1 appearance-none border-0 cursor-pointer focus:ring-2 focus:ring-blue-500 <?php echo e($colorClass); ?>">
                                    ...
                                    <option value="ended" <?php echo e($item->status == 'ended' ? 'selected' : ''); ?> class="bg-white text-slate-900 dark:bg-slate-800 dark:text-white">Ended</option>
                                    ...
                                    <option value="confirmed/booked" <?php echo e($item->status == 'confirmed/booked' ? 'selected' : ''); ?> class="bg-white text-slate-900 dark:bg-slate-800 dark:text-white">Confirmed/Booked</option>
                                </select>
                            </td>
                            <td class="px-6 py-4"><?php echo e($item->category); ?></td>
                            <td class="px-6 py-4"><?php echo e($item->contact); ?></td>
                            ...
                            <td class="px-6 py-4">
                                <?php if($item->proof_of_completion): ?>
                                    <a href="<?php echo e($item->proof_of_completion); ?>" target="_blank" class="text-blue-600 hover:underline">View Link</a>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 max-w-[200px] truncate" title="<?php echo e($item->remarks); ?>"><?php echo e($item->remarks); ?></td>
                            <td class="whitespace-nowrap px-6 py-4 text-right">
                                ...
                                <br>
                                <button type="button" onclick="openDeleteModal(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->name)); ?>')" class="text-rose-600 hover:text-rose-800 dark:hover:text-rose-400 font-medium mt-1">Delete</button>
                            </td>
                        </tr>
