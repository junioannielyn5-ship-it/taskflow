...
<aside
    ...
    <div id="gbl-sidebar-header"
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 group" aria-label="Go to Dashboard">
    ...
    <div id="gbl-sidebar-usercard" class="relative px-4 py-3 shrink-0 z-10">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                <p class="truncate text-sm font-bold text-slate-800 dark:text-white drop-shadow-sm"><?php echo e(auth()->user()->name); ?></p>
                <p class="truncate text-[11px] text-slate-500/80 dark:text-slate-400/70"><?php echo e(auth()->user()->email); ?></p>
            </div>
    ...
    <nav class="relative flex-1 overflow-y-auto px-3 py-3 gbl-sidebar-scroll z-10" aria-label="Sidebar navigation">
        ...
        <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e($link['href']); ?>"
               class="gbl-nav-link <?php echo e($link['active'] ? 'gbl-nav-active' : ''); ?>"
               <?php if($link['active']): ?> aria-current="page" <?php endif; ?>>
                ...
                <?php if(isset($link['badge']) && $link['badge']): ?>
                    <span class="ml-auto flex h-5 min-w-[1.25rem] items-center justify-center rounded-full
                        ...
                        <?php echo e($link['badge'] > 99 ? '99+' : $link['badge']); ?>
        ...
        <?php if(isset($inventoryLinks) && count($inventoryLinks) > 0): ?>
            <div class="gbl-nav-divider"></div>
            <p class="gbl-nav-section">Inventory Hub</p>

            <?php $__currentLoopData = $inventoryLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($link['href']); ?>"
                   class="gbl-nav-link <?php echo e($link['active'] ? 'gbl-nav-active' : ''); ?>"
                   <?php if($link['active']): ?> aria-current="page" <?php endif; ?>>
                    <span class="gbl-nav-icon">
        ...
        <?php $hasRoleLinks = collect($navLinks)->contains('always', false); ?>
        <?php if($hasRoleLinks): ?>
            <div class="gbl-nav-divider"></div>
