...
<div class="space-y-6">
    <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <a href="<?php echo e(route('tasks.calendar')); ?>" class="rounded-full border border-emerald-300 bg-emerald-50 px-4 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-100">Open Calendar</a>
        </div>
    </div>
    ...
    <div class="rounded-xl border border-amber-200 bg-amber-50 p-6 text-center text-amber-700 text-sm font-semibold">
        ...
        <a href="<?php echo e(route('tasks.calendar')); ?>" class="mt-4 inline-block rounded-full border border-emerald-300 bg-emerald-50 px-4 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-100">Open Calendar</a>
    </div>
</div>
