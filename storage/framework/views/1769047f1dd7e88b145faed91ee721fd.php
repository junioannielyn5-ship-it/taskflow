...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-2">
            <a href="<?php echo e(route('projects.index')); ?>" class="rounded-xl border border-slate-300 dark:border-slate-600 px-4 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-slate-700/50">Cancel</a>
