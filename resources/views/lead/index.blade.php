...
<div class="space-y-6">
    ...
    <section class="grid gap-4 md:grid-cols-3">
        <a href="{{ route('tasks.list') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-amber-300 dark:hover:border-amber-500 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgba(245,158,11,0.15)]">
        ...
        <a href="{{ route('dashboard') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-amber-300 dark:hover:border-amber-500 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgba(245,158,11,0.15)]">
        ...
        <a href="{{ route('reports.index') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-amber-300 dark:hover:border-amber-500 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgba(245,158,11,0.15)]">
