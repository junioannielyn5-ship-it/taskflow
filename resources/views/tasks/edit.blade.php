...
<div class="max-w-2xl mx-auto p-6 bg-white dark:bg-slate-800 rounded-xl shadow">
    ...
    <form action="{{ route('tasks.update', $task->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="title" value="{{ $task->title }}" class="w-full border rounded px-3 py-2 bg-white dark:bg-slate-800 text-gray-900 dark:bg-slate-800 dark:text-white" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="due_date" id="due_date" value="{{ $task->due_date ? $task->due_date->format('Y-m-d') : '' }}" class="w-full border rounded px-3 py-2 bg-white dark:bg-slate-800 text-gray-900 dark:bg-slate-800 dark:text-white">
        </div>
        <div class="mb-3">
