...
<head>
    ...
    <title>{{ $roleLabel }} Login — Movaflex</title>
        ...
        <div class="relative flex flex-col justify-center bg-white p-8 md:p-10 lg:p-12">
            ...
            <div class="relative mx-auto w-full max-w-sm">
                ...
                <div class="mb-6 flex justify-center lg:hidden">
                    <img src="{{ asset('images/movaflex-logo-official.png') }}" alt="Movaflex Logo" class="h-16 w-auto">
                </div>
                ...
                <form method="POST" action="{{ route('role.login.attempt', ['role' => $role]) }}" class="space-y-5">
                    @csrf
