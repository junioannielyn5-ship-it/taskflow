            ...
            <div class="relative mt-0 overflow-hidden rounded-3xl dashboard-glass-panel border-none p-5 md:p-6 shadow-md dark:shadow-none transition-all duration-300">
                ...
                <div class="relative z-10 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                    ...
                    <div class="flex w-full shrink-0 flex-col gap-2 sm:flex-row md:w-auto">
                        <a href="{{ route('tasks.list') }}" class="flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-bold text-white shadow-md dark:shadow-none transition-all duration-300 hover:bg-blue-700">
            ...
            <div class="dashboard-stats grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 -mt-4">
                ...
                <a href="/projects" class="relative overflow-hidden rounded-3xl dashboard-glass-panel border-none p-6 group hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-slate-800 dark:text-slate-100 text-4xl font-black">{{ $totalProjects }}</h3>
                ...
                <a href="{{ route('tasks.list') }}" class="relative overflow-hidden rounded-3xl dashboard-glass-panel border-none p-6 group hover:shadow-lg transition-all duration-300">
                    <div class="relative z-10">
                        ...
                        <h3 class="text-slate-800 dark:text-slate-100 text-4xl font-black">{{ $totalTasks }}</h3>
                        <div class="mt-4 h-1.5 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                ...
                <a href="{{ route('tasks.list', ['status' => 'for_review']) }}" class="relative overflow-hidden rounded-3xl dashboard-glass-panel border-none p-6 group hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-slate-800 dark:text-slate-100 text-4xl font-black">{{ $pendingReview }}</h3>
                        <div class="mt-4 h-1.5 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                ...
                <a href="{{ route('tasks.list') }}" class="relative overflow-hidden rounded-3xl dashboard-glass-panel border-none p-6 group hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-slate-800 dark:text-slate-100 text-4xl font-black">{{ $overdue }}</h3>
                        <div class="mt-4 h-1.5 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                ...
                <div id="latest-notifications-card" class="relative overflow-hidden rounded-2xl dashboard-glass-panel border-none p-5 shadow-md dark:shadow-none transition-all scroll-mt-24" style="border-left: 4px solid #2563eb;">
                    <div class="mb-4 flex items-center justify-between gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            <a href="{{ route('dashboard.export.status-overview.csv') }}" class="rounded border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 px-3 py-1.5 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-600">CSV</a>
                            <a href="{{ route('dashboard.export.status-overview.pdf') }}" class="rounded border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 px-3 py-1.5 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-600">PDF</a>
                        </div>
                    </div>
                    <p class="mb-3 text-sm text-slate-600 dark:text-slate-400">Done: <span id="done-percentage" class="font-semibold text-emerald-600">{{ $donePercentage }}%</span> · In Progress: <span id="in-progress-percentage" class="font-semibold text-blue-600">{{ $inProgressPercentage }}%</span></p>
