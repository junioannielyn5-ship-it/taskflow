...
<div class="space-y-6">
    ...
    <section class="grid gap-4 md:grid-cols-3">
        @can('create-project')
            <a href="{{ route('projects.create') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-md">
        ...
        <a href="{{ route('tasks.list') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-md">
        ...
        <a href="{{ route('reports.index') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-md">
    ...
    <section class="grid gap-4 md:grid-cols-2">
        <a href="{{ route('meetings.index') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-white to-emerald-50 dark:from-slate-800 dark:to-emerald-900/10 p-5 shadow-sm transition hover:border-emerald-300 dark:hover:border-emerald-600">
        ...
        <a href="{{ route('holidays.index') }}" class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-white to-cyan-50 dark:from-slate-800 dark:to-cyan-900/10 p-5 shadow-sm transition hover:border-cyan-300 dark:hover:border-cyan-600">
